...
unsigned int GetCRC32(unsigned char* buf, unsigned int len)
{
  ...
  for (unsigned int i = 0; i != len; ++i)
  {
    ...
    CRC32_data = ((CRC32_data >> 8) & 0xFFFFFF) ^ aulCrcTable[t];
  }
  return ~CRC32_data;
}

 unsigned long Cal_BlockCRC32(  unsigned long ulCount, unsigned char* ucBuffer )
{ 
	 unsigned long ulTemp1; 
	 unsigned long ulTemp2; 
	 unsigned long ulCRC = 0; 
...
uint8_t buf2[300]=
{
										 } ;


/***
 *
 * 
41 41 34 34 41 41 34 35  54 47 28 C0 83 E2 6D C0  38 C9 0B 41 3D 1F 91 BC  B5 33 F0 BB B5 33 F0 B9 
00 00 00 00 00 00 F8 41  32 FB 90 3E 00 00 F2 42  52 37 53 3E 50 40 55 42  1D 8A 25 3C 8D C2 27 3C 
D1 BD B3 3C 00 00 80 40  00 00 00 00 08 16 38 3C  3A 93 5F 40 CD CC 4C 3E  00 00 2C 42 00 00 1C 42 
1A 28 96 3C CD CC 4C 3D  00 00 00 00 00 50 08 46  00 98 3D 47 00 00 00 00  00 00 00 00 00 94 03 42 
00 00 F8 41 31 FB 90 3E  00 00 F2 42 53 37 53 3E  80 47 55 42 EC BC EC 38  4A CE A9 BB CD 83 39 3B 
60 3E 4B 3E 18 DF 8D 3E  05 BB C0 BE 40 2C 36 48  13 30 08 4E 00 00 00 00  00 00 00 00 00 00 00 00 
00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00 
00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00  00 00 00 00 B1 04 63 04  00 00 1C 42 00 00 00 00 
00 00 00 00 BC BB C7 41  00 00 C8 41 00 44 11 46  54 47 28 C0 83 E2 6D C0  00 00 00 00 00 00 00 00 
00 00 00 00 B5 33 F0 B9  B9 76 85 DE 00 41 4E 48  80 A7 5B 48 00 00 1E 44  

***/
    uint8_t buf[40] = 
    {
    0x91,0x00,0x01,0xc8,0x00,0x00,0xcd,0x00,0x00,0x20,
    0x00,0x00,0x16,0xfb,0xff,0xfc,0xa6,0x07,0xfb,0xb9,
    0x00,0xc9,0x01,0xfa,0x00,0x14,0x40,0x00,0x13,0x71,
	0x13,0x6a,0x13,0x57,0x00,0x41,0x01,0xfa,0x00,0x00
    };
    //91 00 01 C8 00 00 CD 00 00 20 00 00 16 FB FF FC A6 07 FB B9 00 C9 01 FA 33 DD B5 32 0D 0A 
   /* CRC = CalculateCRC32(buf,40); */
    CRC = ~calculate_crc32_r(buf2,288,0x00000000);
	CRC2 = Cal_BlockCRC32(288,buf2);
	CRC3 = CalculateCRC32(buf2,288);
    printf("%x\n",CRC);
	printf("%x\n",CRC2);
	printf("%x\n",CRC3);
    return 0;
